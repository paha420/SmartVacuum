...
# ---- НАСТРОЙКИ ----
# Впиши MAC-адреса своих телефонов вместо примеров ниже
PHONE_MACS = {
    "AA:BB:CC:DD:EE:FF",
    # "11:22:33:44:55:66",
...
# Названия Wi‑Fi интерфейсов на роутере (5 ГГц и 2.4 ГГц)
AP_INTERFACES = ["wifi0", "wifi1"]  # замени на свои значения
...
ROUTER_IP = "192.168.0.1"           # адрес твоего роутера
VACUUM_IP = "192.168.0.100"         # адрес пылесоса
VACUUM_TOKEN = "YOUR_VACUUM_TOKEN"  # токен пылесоса
